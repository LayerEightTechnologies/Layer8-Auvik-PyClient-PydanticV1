...
class DeviceLifecycleReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceLifecycleReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceLifecycleReadMultipleLinks:
        """Create an instance of DeviceLifecycleReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceLifecycleReadMultipleLinks.parse_obj(obj)

        _obj = DeviceLifecycleReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

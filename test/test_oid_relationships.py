...
from layer8_auvik_api_client.models.oid_relationships import OidRelationships  # noqa: E501

class TestOidRelationships(unittest.TestCase):
    """OidRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OidRelationships:
        """Test OidRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OidRelationships`
        """
        model = OidRelationships()  # noqa: E501
        if include_optional:
            return OidRelationships(

...
class DeviceRelationships(BaseModel):
    """
    ...
    __properties = ["tenant", "networks", "deviceDetail"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceRelationships:
        """Create an instance of DeviceRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceRelationships.parse_obj(obj)

        _obj = DeviceRelationships.parse_obj({

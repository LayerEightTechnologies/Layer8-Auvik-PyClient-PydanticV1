...
class EntityAuditReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityAuditReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityAuditReadMultipleLinks:
        """Create an instance of EntityAuditReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityAuditReadMultipleLinks.parse_obj(obj)

        _obj = EntityAuditReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

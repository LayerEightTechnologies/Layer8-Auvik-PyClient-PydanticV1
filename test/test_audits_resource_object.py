...
from layer8_auvik_api_client.models.audits_resource_object import AuditsResourceObject  # noqa: E501

class TestAuditsResourceObject(unittest.TestCase):
    """AuditsResourceObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditsResourceObject:
        """Test AuditsResourceObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditsResourceObject`
        """
        model = AuditsResourceObject()  # noqa: E501
        if include_optional:
            return AuditsResourceObject(
                type = 'entityAudit',
    ...
    def testAuditsResourceObject(self):
        """Test AuditsResourceObject"""

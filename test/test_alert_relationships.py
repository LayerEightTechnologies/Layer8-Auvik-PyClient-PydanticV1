...
from layer8_auvik_api_client.models.alert_relationships import AlertRelationships  # noqa: E501

class TestAlertRelationships(unittest.TestCase):
    """AlertRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertRelationships:
        """Test AlertRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertRelationships`
        """
        model = AlertRelationships()  # noqa: E501
        if include_optional:
            return AlertRelationships(
                ...
                related_alert = layer8_auvik_api_client.models.alert_relationships_related_alert.alertRelationships_relatedAlert(
                    data = layer8_auvik_api_client.models.alert_relationships_related_alert_data.alertRelationships_relatedAlert_data(
                        type = 'alert', 
                ...
                entity = layer8_auvik_api_client.models.alert_relationships_entity.alertRelationships_entity(
                    data = layer8_auvik_api_client.models.alert_relationships_entity_data.alertRelationships_entity_data(
                        type = 'interface', 
                        id = 'MTg2OTI2NTY1MDQ3MDExMDc0LDE5Nzc2OTU1ODM1MTAyMTMxOA', 
                        links = layer8_auvik_api_client.models.alert_relationships_entity_data_links.alertRelationships_entity_data_links(
    ...
    def testAlertRelationships(self):
        """Test AlertRelationships"""

...
class ConfigReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigReadMultipleLinks:
        """Create an instance of ConfigReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigReadMultipleLinks.parse_obj(obj)

        _obj = ConfigReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

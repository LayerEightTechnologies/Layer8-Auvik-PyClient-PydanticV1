...
class DeviceDetailsReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceDetailsReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceDetailsReadMultipleLinks:
        """Create an instance of DeviceDetailsReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceDetailsReadMultipleLinks.parse_obj(obj)

        _obj = DeviceDetailsReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

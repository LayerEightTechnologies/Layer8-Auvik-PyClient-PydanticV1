...
class SnmpPollerSettingsResourceObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerSettingsResourceObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerSettingsResourceObject:
        """Create an instance of SnmpPollerSettingsResourceObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerSettingsResourceObject.parse_obj(obj)

        _obj = SnmpPollerSettingsResourceObject.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),

...
class AlertHistoryInfoReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertHistoryInfoReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlertHistoryInfoReadMultipleLinks:
        """Create an instance of AlertHistoryInfoReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertHistoryInfoReadMultipleLinks.parse_obj(obj)

        _obj = AlertHistoryInfoReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

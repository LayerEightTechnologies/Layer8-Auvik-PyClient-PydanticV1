...
from layer8_auvik_api_client.models.note_resource_object import NoteResourceObject  # noqa: E501

class TestNoteResourceObject(unittest.TestCase):
    """NoteResourceObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteResourceObject:
        """Test NoteResourceObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteResourceObject`
        """
        model = NoteResourceObject()  # noqa: E501
        if include_optional:
            return NoteResourceObject(
                type = 'entityNote',
    ...
    def testNoteResourceObject(self):
        """Test NoteResourceObject"""

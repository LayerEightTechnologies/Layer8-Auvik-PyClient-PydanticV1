...
class StackAllOfAttributes(BaseModel):
    """
    ...
    def device_type_validate_enum(cls, value):
        ...
        if value not in ('stack'):
            raise ValueError("must be one of enum values ('stack')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StackAllOfAttributes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StackAllOfAttributes:
        """Create an instance of StackAllOfAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StackAllOfAttributes.parse_obj(obj)

        _obj = StackAllOfAttributes.parse_obj({

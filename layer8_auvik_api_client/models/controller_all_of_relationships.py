...
class ControllerAllOfRelationships(BaseModel):
    """
    ...
    access_points: Optional[conlist(ControllerAllOfRelationshipsAllOfAccessPointsInner)] = Field(None, alias="accessPoints", description="List of access points associated to this controller")
    __properties = ["tenant", "networks", "deviceDetail", "accessPoints"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ControllerAllOfRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ControllerAllOfRelationships:
        """Create an instance of ControllerAllOfRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ControllerAllOfRelationships.parse_obj(obj)

        _obj = ControllerAllOfRelationships.parse_obj({
            ...
            "access_points": [ControllerAllOfRelationshipsAllOfAccessPointsInner.from_dict(_item) for _item in obj.get("accessPoints")] if obj.get("accessPoints") is not None else None
        })
        return _obj

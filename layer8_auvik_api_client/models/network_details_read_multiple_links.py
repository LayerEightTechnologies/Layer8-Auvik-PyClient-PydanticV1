...
class NetworkDetailsReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDetailsReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDetailsReadMultipleLinks:
        """Create an instance of NetworkDetailsReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDetailsReadMultipleLinks.parse_obj(obj)

        _obj = NetworkDetailsReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

...
from layer8_auvik_api_client.models.alert_history_info_read_single import AlertHistoryInfoReadSingle  # noqa: E501

class TestAlertHistoryInfoReadSingle(unittest.TestCase):
    """AlertHistoryInfoReadSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertHistoryInfoReadSingle:
        """Test AlertHistoryInfoReadSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertHistoryInfoReadSingle`
        """
        model = AlertHistoryInfoReadSingle()  # noqa: E501
        if include_optional:
            return AlertHistoryInfoReadSingle(
                data = layer8_auvik_api_client.models.alerts_resource_object.alertsResourceObject(
                    type = 'alert', 
    ...
    def testAlertHistoryInfoReadSingle(self):
        """Test AlertHistoryInfoReadSingle"""

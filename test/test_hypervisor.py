...
from layer8_auvik_api_client.models.hypervisor import Hypervisor  # noqa: E501
...
class TestHypervisor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Hypervisor:
        """Test Hypervisor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Hypervisor`
        """
        model = Hypervisor()  # noqa: E501
        if include_optional:
            return Hypervisor(

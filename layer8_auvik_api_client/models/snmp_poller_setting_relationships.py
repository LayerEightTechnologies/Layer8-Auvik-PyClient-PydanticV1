...
class SnmpPollerSettingRelationships(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerSettingRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerSettingRelationships:
        """Create an instance of SnmpPollerSettingRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerSettingRelationships.parse_obj(obj)

        _obj = SnmpPollerSettingRelationships.parse_obj({

...
class InterfaceStatisticsRelationships(BaseModel):
    """
    Interface statistics object's relationships to other resources  # noqa: E501
    """
    interface: Optional[InterfaceStatisticsRelationshipsInterface] = None
    tenant: Optional[Tenant] = None
    __properties = ["interface", "tenant"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterfaceStatisticsRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterfaceStatisticsRelationships:
        """Create an instance of InterfaceStatisticsRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterfaceStatisticsRelationships.parse_obj(obj)

        _obj = InterfaceStatisticsRelationships.parse_obj({
            "interface": InterfaceStatisticsRelationshipsInterface.from_dict(obj.get("interface")) if obj.get("interface") is not None else None,

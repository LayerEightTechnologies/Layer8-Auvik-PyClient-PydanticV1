...
from layer8_auvik_api_client.models.interface_info_read_single import InterfaceInfoReadSingle  # noqa: E501

class TestInterfaceInfoReadSingle(unittest.TestCase):
    """InterfaceInfoReadSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceInfoReadSingle:
        """Test InterfaceInfoReadSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceInfoReadSingle`
        """
        model = InterfaceInfoReadSingle()  # noqa: E501
        if include_optional:
            return InterfaceInfoReadSingle(
                data = layer8_auvik_api_client.models.interface_resource_object.interfaceResourceObject(
                    type = 'interface', 
    ...
    def testInterfaceInfoReadSingle(self):
        """Test InterfaceInfoReadSingle"""

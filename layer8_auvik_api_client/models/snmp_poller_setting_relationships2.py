...
class SnmpPollerSettingRelationships2(BaseModel):
    """
    This SNMP Poller Setting's relationships to other resources  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerSettingRelationships2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerSettingRelationships2:
        """Create an instance of SnmpPollerSettingRelationships2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerSettingRelationships2.parse_obj(obj)

        _obj = SnmpPollerSettingRelationships2.parse_obj({

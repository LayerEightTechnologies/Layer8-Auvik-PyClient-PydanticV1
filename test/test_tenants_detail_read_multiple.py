...
from layer8_auvik_api_client.models.tenants_detail_read_multiple import TenantsDetailReadMultiple  # noqa: E501

class TestTenantsDetailReadMultiple(unittest.TestCase):
    """TenantsDetailReadMultiple unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantsDetailReadMultiple:
        """Test TenantsDetailReadMultiple
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TenantsDetailReadMultiple`
        """
        model = TenantsDetailReadMultiple()  # noqa: E501
        if include_optional:
            return TenantsDetailReadMultiple(
                data = [
                    layer8_auvik_api_client.models.tenant_detail_resource_object.tenantDetailResourceObject(
                        type = 'tenants', 
                        id = '0987654321', 
    ...
    def testTenantsDetailReadMultiple(self):
        """Test TenantsDetailReadMultiple"""

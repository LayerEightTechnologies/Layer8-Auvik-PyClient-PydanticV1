...
class DeviceRelationshipsNetworksData(BaseModel):
    """
    ...
    links: Optional[DeviceRelationshipsNetworksLinks] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceRelationshipsNetworksData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceRelationshipsNetworksData:
        """Create an instance of DeviceRelationshipsNetworksData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceRelationshipsNetworksData.parse_obj(obj)

        _obj = DeviceRelationshipsNetworksData.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            ...
            "links": DeviceRelationshipsNetworksLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj

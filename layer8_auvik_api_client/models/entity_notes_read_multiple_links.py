...
class EntityNotesReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityNotesReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityNotesReadMultipleLinks:
        """Create an instance of EntityNotesReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityNotesReadMultipleLinks.parse_obj(obj)

        _obj = EntityNotesReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

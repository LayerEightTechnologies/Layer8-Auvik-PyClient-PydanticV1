...
class ConfigurationApi:
    ...
    @validate_arguments
    def read_multiple_configurations(self, filter_device_id : Annotated[Optional[StrictStr], Field(description="Filter by device ID")] = None, filter_backup_time_after : Annotated[Optional[StrictStr], Field(description="Filter by date and time, filtering out configurations backed up before value.")] = None, filter_backup_time_before : Annotated[Optional[StrictStr], Field(description="Filter by date and time, filtering out configurations backed up after value.")] = None, filter_is_running : Annotated[Optional[StrictBool], Field(description="Filter for configurations that are currently running, or filter for all configurations which are not currently running.")] = None, tenants : Annotated[Optional[StrictStr], Field(description="Comma delimited list of tenant IDs to request info from.")] = None, page_first : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the first N elements will be returned. Used in combination with <code>page[after]</code>.")] = None, page_after : Annotated[Optional[StrictStr], Field(description="Cursor after which elements will be returned as a page. The page size is provided by <code>page[first]</code>.")] = None, page_last : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the last N services will be returned. Used in combination with <code>page[before]</code>.")] = None, page_before : Annotated[Optional[StrictStr], Field(description="Cursor before which elements will be returned as a page. The page size is provided by <code>page[last]</code>.")] = None, **kwargs) -> ConfigReadMultiple:  # noqa: E501
        ...
        >>> thread = api.read_multiple_configurations(filter_device_id, filter_backup_time_after, filter_backup_time_before, filter_is_running, tenants, page_first, page_after, page_last, page_before, async_req=True)
        >>> result = thread.get()

        :param filter_device_id: Filter by device ID
        :type filter_device_id: str
        :param filter_backup_time_after: Filter by date and time, filtering out configurations backed up before value.
        :type filter_backup_time_after: str
        :param filter_backup_time_before: Filter by date and time, filtering out configurations backed up after value.
        :type filter_backup_time_before: str
        :param filter_is_running: Filter for configurations that are currently running, or filter for all configurations which are not currently running.
        :type filter_is_running: bool
        ...
        :rtype: ConfigReadMultiple
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_multiple_configurations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_multiple_configurations_with_http_info(filter_device_id, filter_backup_time_after, filter_backup_time_before, filter_is_running, tenants, page_first, page_after, page_last, page_before, **kwargs)  # noqa: E501

    @validate_arguments
    def read_multiple_configurations_with_http_info(self, filter_device_id : Annotated[Optional[StrictStr], Field(description="Filter by device ID")] = None, filter_backup_time_after : Annotated[Optional[StrictStr], Field(description="Filter by date and time, filtering out configurations backed up before value.")] = None, filter_backup_time_before : Annotated[Optional[StrictStr], Field(description="Filter by date and time, filtering out configurations backed up after value.")] = None, filter_is_running : Annotated[Optional[StrictBool], Field(description="Filter for configurations that are currently running, or filter for all configurations which are not currently running.")] = None, tenants : Annotated[Optional[StrictStr], Field(description="Comma delimited list of tenant IDs to request info from.")] = None, page_first : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the first N elements will be returned. Used in combination with <code>page[after]</code>.")] = None, page_after : Annotated[Optional[StrictStr], Field(description="Cursor after which elements will be returned as a page. The page size is provided by <code>page[first]</code>.")] = None, page_last : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the last N services will be returned. Used in combination with <code>page[before]</code>.")] = None, page_before : Annotated[Optional[StrictStr], Field(description="Cursor before which elements will be returned as a page. The page size is provided by <code>page[last]</code>.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Read Multiple Device Configurations  # noqa: E501
        ...
        >>> thread = api.read_multiple_configurations_with_http_info(filter_device_id, filter_backup_time_after, filter_backup_time_before, filter_is_running, tenants, page_first, page_after, page_last, page_before, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ConfigReadMultiple, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _all_params = [
            'filter_device_id',
            'filter_backup_time_after',
            'filter_backup_time_before',
            'filter_is_running',
            'tenants',
            'page_first',
            'page_after',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method read_multiple_configurations" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('filter_backup_time_after') is not None:  # noqa: E501
            _query_params.append(('filter[backupTimeAfter]', _params['filter_backup_time_after']))

        if _params.get('filter_backup_time_before') is not None:  # noqa: E501
            _query_params.append(('filter[backupTimeBefore]', _params['filter_backup_time_before']))

        if _params.get('filter_is_running') is not None:  # noqa: E501
            _query_params.append(('filter[isRunning]', _params['filter_is_running']))
    ...
    @validate_arguments
    def read_single_configuration(self, id : Annotated[StrictStr, Field(..., description="ID of configuration")], **kwargs) -> ConfigReadSingle:  # noqa: E501
        ...
        >>> thread = api.read_single_configuration(id, async_req=True)
        >>> result = thread.get()

        :param id: ID of configuration (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ConfigReadSingle
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_single_configuration_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_single_configuration_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def read_single_configuration_with_http_info(self, id : Annotated[StrictStr, Field(..., description="ID of configuration")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Single Device Configuration  # noqa: E501
        ...
        >>> thread = api.read_single_configuration_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ConfigReadSingle, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_single_configuration" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/inventory/configuration/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,

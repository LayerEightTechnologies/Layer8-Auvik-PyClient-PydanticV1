...
class NetworkInfoReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkInfoReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkInfoReadMultipleLinks:
        """Create an instance of NetworkInfoReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkInfoReadMultipleLinks.parse_obj(obj)

        _obj = NetworkInfoReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

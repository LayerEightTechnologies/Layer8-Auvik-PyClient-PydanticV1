...
from layer8_auvik_api_client.models.tenant_detail_resource_object import TenantDetailResourceObject  # noqa: E501

class TestTenantDetailResourceObject(unittest.TestCase):
    """TenantDetailResourceObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantDetailResourceObject:
        """Test TenantDetailResourceObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TenantDetailResourceObject`
        """
        model = TenantDetailResourceObject()  # noqa: E501
        if include_optional:
            return TenantDetailResourceObject(
                type = 'tenants',
                id = '0987654321',
    ...
    def testTenantDetailResourceObject(self):
        """Test TenantDetailResourceObject"""

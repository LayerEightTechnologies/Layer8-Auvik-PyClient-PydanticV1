...
class DeviceOidMonitorReadLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceOidMonitorReadLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceOidMonitorReadLinks:
        """Create an instance of DeviceOidMonitorReadLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceOidMonitorReadLinks.parse_obj(obj)

        _obj = DeviceOidMonitorReadLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

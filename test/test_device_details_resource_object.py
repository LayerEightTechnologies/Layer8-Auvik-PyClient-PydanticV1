...
from layer8_auvik_api_client.models.device_details_resource_object import DeviceDetailsResourceObject  # noqa: E501

class TestDeviceDetailsResourceObject(unittest.TestCase):
    """DeviceDetailsResourceObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceDetailsResourceObject:
        """Test DeviceDetailsResourceObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceDetailsResourceObject`
        """
        model = DeviceDetailsResourceObject()  # noqa: E501
        if include_optional:
            return DeviceDetailsResourceObject(
                type = 'deviceDetail',
    ...
    def testDeviceDetailsResourceObject(self):
        """Test DeviceDetailsResourceObject"""

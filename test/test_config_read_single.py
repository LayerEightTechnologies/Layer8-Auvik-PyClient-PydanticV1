...
from layer8_auvik_api_client.models.config_read_single import ConfigReadSingle  # noqa: E501

class TestConfigReadSingle(unittest.TestCase):
    """ConfigReadSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigReadSingle:
        """Test ConfigReadSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigReadSingle`
        """
        model = ConfigReadSingle()  # noqa: E501
        if include_optional:
            return ConfigReadSingle(
                data = layer8_auvik_api_client.models.config_resource_object.configResourceObject(
                    type = 'configuration', 

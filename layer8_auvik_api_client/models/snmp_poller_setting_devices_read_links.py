...
class SnmpPollerSettingDevicesReadLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerSettingDevicesReadLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerSettingDevicesReadLinks:
        """Create an instance of SnmpPollerSettingDevicesReadLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerSettingDevicesReadLinks.parse_obj(obj)

        _obj = SnmpPollerSettingDevicesReadLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

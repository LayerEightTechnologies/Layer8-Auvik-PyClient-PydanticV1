...
class ComponentStatisticsRelationships(BaseModel):
    """
    Component statistics object's relationships to other resources  # noqa: E501
    """
    component: Optional[ComponentStatisticsRelationshipsComponent] = None
    tenant: Optional[Tenant] = None
    __properties = ["component", "tenant"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComponentStatisticsRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComponentStatisticsRelationships:
        """Create an instance of ComponentStatisticsRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComponentStatisticsRelationships.parse_obj(obj)

        _obj = ComponentStatisticsRelationships.parse_obj({
            "component": ComponentStatisticsRelationshipsComponent.from_dict(obj.get("component")) if obj.get("component") is not None else None,

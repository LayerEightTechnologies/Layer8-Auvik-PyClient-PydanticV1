...
class ComponentInfoReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComponentInfoReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComponentInfoReadMultipleLinks:
        """Create an instance of ComponentInfoReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComponentInfoReadMultipleLinks.parse_obj(obj)

        _obj = ComponentInfoReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

...
class InterfaceInfoReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterfaceInfoReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterfaceInfoReadMultipleLinks:
        """Create an instance of InterfaceInfoReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterfaceInfoReadMultipleLinks.parse_obj(obj)

        _obj = InterfaceInfoReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

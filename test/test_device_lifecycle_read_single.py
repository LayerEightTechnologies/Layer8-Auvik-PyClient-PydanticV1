...
from layer8_auvik_api_client.models.device_lifecycle_read_single import DeviceLifecycleReadSingle  # noqa: E501

class TestDeviceLifecycleReadSingle(unittest.TestCase):
    """DeviceLifecycleReadSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceLifecycleReadSingle:
        """Test DeviceLifecycleReadSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceLifecycleReadSingle`
        """
        model = DeviceLifecycleReadSingle()  # noqa: E501
        if include_optional:
            return DeviceLifecycleReadSingle(
                data = layer8_auvik_api_client.models.device_lifecycle_resource_object.deviceLifecycleResourceObject(
    ...
    def testDeviceLifecycleReadSingle(self):
        """Test DeviceLifecycleReadSingle"""

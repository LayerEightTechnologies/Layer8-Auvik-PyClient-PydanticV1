...
from layer8_auvik_api_client.models.device_usage_relationships_client_data import DeviceUsageRelationshipsClientData  # noqa: E501

class TestDeviceUsageRelationshipsClientData(unittest.TestCase):
    """DeviceUsageRelationshipsClientData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceUsageRelationshipsClientData:
        """Test DeviceUsageRelationshipsClientData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceUsageRelationshipsClientData`
        """
        model = DeviceUsageRelationshipsClientData()  # noqa: E501
        if include_optional:
            return DeviceUsageRelationshipsClientData(
    ...
    def testDeviceUsageRelationshipsClientData(self):
        """Test DeviceUsageRelationshipsClientData"""

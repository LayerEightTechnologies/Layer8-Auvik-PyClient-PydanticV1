...
class NetworkDetailsRelationships(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDetailsRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDetailsRelationships:
        """Create an instance of NetworkDetailsRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDetailsRelationships.parse_obj(obj)

        _obj = NetworkDetailsRelationships.parse_obj({

...
class DeviceWarrantyRelationships(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceWarrantyRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceWarrantyRelationships:
        """Create an instance of DeviceWarrantyRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceWarrantyRelationships.parse_obj(obj)

        _obj = DeviceWarrantyRelationships.parse_obj({

...
class SnmpPollerStringHistoryReadLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerStringHistoryReadLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerStringHistoryReadLinks:
        """Create an instance of SnmpPollerStringHistoryReadLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerStringHistoryReadLinks.parse_obj(obj)

        _obj = SnmpPollerStringHistoryReadLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

...
from layer8_auvik_api_client.models.config_relationships import ConfigRelationships  # noqa: E501

class TestConfigRelationships(unittest.TestCase):
    """ConfigRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigRelationships:
        """Test ConfigRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigRelationships`
        """
        model = ConfigRelationships()  # noqa: E501
        if include_optional:
            return ConfigRelationships(
    ...
    def testConfigRelationships(self):
        """Test ConfigRelationships"""

...
class ControllerAllOfAttributes(BaseModel):
    """
    ...
    __properties = ["deviceName", "lastModified", "lastSeenTime", "deviceType"]

    @validator('device_type')
    def device_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('controller'):
            raise ValueError("must be one of enum values ('controller')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ControllerAllOfAttributes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ControllerAllOfAttributes:
        """Create an instance of ControllerAllOfAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ControllerAllOfAttributes.parse_obj(obj)

        _obj = ControllerAllOfAttributes.parse_obj({

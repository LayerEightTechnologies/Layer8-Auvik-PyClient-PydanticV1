...
from layer8_auvik_api_client.models.device_statistics_relationships import DeviceStatisticsRelationships  # noqa: E501

class TestDeviceStatisticsRelationships(unittest.TestCase):
    """DeviceStatisticsRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceStatisticsRelationships:
        """Test DeviceStatisticsRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceStatisticsRelationships`
        """
        model = DeviceStatisticsRelationships()  # noqa: E501
        if include_optional:
            return DeviceStatisticsRelationships(
    ...
    def testDeviceStatisticsRelationships(self):
        """Test DeviceStatisticsRelationships"""

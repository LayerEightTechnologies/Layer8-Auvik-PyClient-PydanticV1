...
from layer8_auvik_api_client.models.network_details_resource_object import NetworkDetailsResourceObject  # noqa: E501

class TestNetworkDetailsResourceObject(unittest.TestCase):
    """NetworkDetailsResourceObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkDetailsResourceObject:
        """Test NetworkDetailsResourceObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkDetailsResourceObject`
        """
        model = NetworkDetailsResourceObject()  # noqa: E501
        if include_optional:
            return NetworkDetailsResourceObject(
                type = 'networkDetail',
    ...
    def testNetworkDetailsResourceObject(self):
        """Test NetworkDetailsResourceObject"""

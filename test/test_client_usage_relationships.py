...
from layer8_auvik_api_client.models.client_usage_relationships import ClientUsageRelationships  # noqa: E501

class TestClientUsageRelationships(unittest.TestCase):
    """ClientUsageRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientUsageRelationships:
        """Test ClientUsageRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientUsageRelationships`
        """
        model = ClientUsageRelationships()  # noqa: E501
        if include_optional:
            return ClientUsageRelationships(
                ...
                clients = layer8_auvik_api_client.models.client_usage_relationships_clients.clientUsageRelationships_clients(
                    data = [
                        layer8_auvik_api_client.models.client_usage_relationships_clients_data.clientUsageRelationships_clients_data(
    ...
    def testClientUsageRelationships(self):
        """Test ClientUsageRelationships"""

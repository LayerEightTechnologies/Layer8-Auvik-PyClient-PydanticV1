...
class SnmpPollerSettingReducedData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerSettingReducedData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerSettingReducedData:
        """Create an instance of SnmpPollerSettingReducedData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerSettingReducedData.parse_obj(obj)

        _obj = SnmpPollerSettingReducedData.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),

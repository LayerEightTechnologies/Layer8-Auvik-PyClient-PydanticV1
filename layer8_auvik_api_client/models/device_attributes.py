...
class DeviceAttributes(BaseModel):
    ...
    """
    ip_addresses: conlist(StrictStr) = Field(..., alias="ipAddresses", description="Device's local IP addresses")
    ...
    make_model: StrictStr = Field(..., alias="makeModel", description="Make and model of this device")
    vendor_name: StrictStr = Field(..., alias="vendorName", description="Vendor name for this device")
    software_version: StrictStr = Field(..., alias="softwareVersion", description="Devices software version, if known")
    serial_number: StrictStr = Field(..., alias="serialNumber", description="Device's serial number")
    description: StrictStr = Field(..., description="Description")
    firmware_version: StrictStr = Field(..., alias="firmwareVersion", description="Device's firmware version")
    last_modified: StrictStr = Field(..., alias="lastModified", description="When one of this device's attributes was last modified")
    last_seen_time: Optional[StrictStr] = Field(None, alias="lastSeenTime", description="Last seen online date/time of a device")
    online_status: StrictStr = Field(..., alias="onlineStatus", description="Device's online status")
    __properties = ["ipAddresses", "deviceName", "deviceType", "makeModel", "vendorName", "softwareVersion", "serialNumber", "description", "firmwareVersion", "lastModified", "lastSeenTime", "onlineStatus"]

    @validator('device_type')
    def device_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('unknown', 'switch', 'l3Switch', 'router', 'accessPoint', 'firewall', 'workstation', 'server', 'storage', 'printer', 'copier', 'hypervisor', 'multimedia', 'phone', 'tablet', 'handheld', 'virtualAppliance', 'bridge', 'controller', 'hub', 'modem', 'ups', 'module', 'loadBalancer', 'camera', 'telecommunications', 'packetProcessor', 'chassis', 'airConditioner', 'virtualMachine', 'pdu', 'ipPhone', 'backhaul', 'internetOfThings', 'voipSwitch', 'stack', 'backupDevice', 'timeClock', 'lightingDevice', 'audioVisual', 'securityAppliance', 'utm', 'alarm', 'buildingManagement', 'ipmi', 'thinAccessPoint', 'thinClient'):
            raise ValueError("must be one of enum values ('unknown', 'switch', 'l3Switch', 'router', 'accessPoint', 'firewall', 'workstation', 'server', 'storage', 'printer', 'copier', 'hypervisor', 'multimedia', 'phone', 'tablet', 'handheld', 'virtualAppliance', 'bridge', 'controller', 'hub', 'modem', 'ups', 'module', 'loadBalancer', 'camera', 'telecommunications', 'packetProcessor', 'chassis', 'airConditioner', 'virtualMachine', 'pdu', 'ipPhone', 'backhaul', 'internetOfThings', 'voipSwitch', 'stack', 'backupDevice', 'timeClock', 'lightingDevice', 'audioVisual', 'securityAppliance', 'utm', 'alarm', 'buildingManagement', 'ipmi', 'thinAccessPoint', 'thinClient')")
        return value

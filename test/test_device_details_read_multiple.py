...
from layer8_auvik_api_client.models.device_details_read_multiple import DeviceDetailsReadMultiple  # noqa: E501

class TestDeviceDetailsReadMultiple(unittest.TestCase):
    """DeviceDetailsReadMultiple unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceDetailsReadMultiple:
        """Test DeviceDetailsReadMultiple
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceDetailsReadMultiple`
        """
        model = DeviceDetailsReadMultiple()  # noqa: E501
        if include_optional:
            return DeviceDetailsReadMultiple(
                data = [
                ...
                links = layer8_auvik_api_client.models.device_details_read_multiple_links.deviceDetailsReadMultiple_links(
                    next = 'https://auvikapi.us1.my.auvik.com/v1/inventory/device/detail?page[after]=Y3Vyc29yOk16TXpPVE0wT0RRNU1UQTROemN4TlRneExETXpNemt6TkRnME56QXpORFF5TmpFeU5R&page[first]=300', 
                    prev = 'https://auvikapi.us1.my.auvik.com/v1/inventory/device/detail?page[before]=Y3Vyc29yOk16TXpPVE0wT0RRNU1UQTROemN4TlRneExETXpNemt6TkRnME56QXpORFF5TmpFeU5R&page[last]=300', 
                    first = 'https://auvikapi.us1.my.auvik.com/v1/inventory/device/detail?page[first]=300', 
                    last = 'https://auvikapi.us1.my.auvik.com/v1/inventory/device/detail?page[last]=300', ),
    ...
    def testDeviceDetailsReadMultiple(self):
        """Test DeviceDetailsReadMultiple"""

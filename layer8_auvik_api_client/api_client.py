...
import layer8_auvik_api_client.models
from layer8_auvik_api_client import rest
from layer8_auvik_api_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(layer8_auvik_api_client.models, klass)

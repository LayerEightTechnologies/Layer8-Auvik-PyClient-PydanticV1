...
class OidRelationships(BaseModel):
    """
    This OID's relationships to other resources  # noqa: E501
    """
    tenant: Optional[Tenant] = None
    device: Optional[OidRelationshipsDevice] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OidRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OidRelationships:
        """Create an instance of OidRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OidRelationships.parse_obj(obj)

        _obj = OidRelationships.parse_obj({
            "tenant": Tenant.from_dict(obj.get("tenant")) if obj.get("tenant") is not None else None,
            "device": OidRelationshipsDevice.from_dict(obj.get("device")) if obj.get("device") is not None else None
        })
        return _obj

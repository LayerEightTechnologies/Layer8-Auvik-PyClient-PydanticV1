...
class AuditRelationships(BaseModel):
    """
    This entity audit's relationships to other resources  # noqa: E501
    """
    tenant: Optional[Tenant] = None
    device: Optional[AuditRelationshipsDevice] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuditRelationships:
        """Create an instance of AuditRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditRelationships.parse_obj(obj)

        _obj = AuditRelationships.parse_obj({
            "tenant": Tenant.from_dict(obj.get("tenant")) if obj.get("tenant") is not None else None,
            "device": AuditRelationshipsDevice.from_dict(obj.get("device")) if obj.get("device") is not None else None
        })
        return _obj

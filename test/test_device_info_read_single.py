...
from layer8_auvik_api_client.models.device_info_read_single import DeviceInfoReadSingle  # noqa: E501

class TestDeviceInfoReadSingle(unittest.TestCase):
    """DeviceInfoReadSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInfoReadSingle:
        """Test DeviceInfoReadSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInfoReadSingle`
        """
        model = DeviceInfoReadSingle()  # noqa: E501
        if include_optional:
            return DeviceInfoReadSingle(
                data = layer8_auvik_api_client.models.devices_resource_object.devicesResourceObject(
                    type = 'device', 
    ...
    def testDeviceInfoReadSingle(self):
        """Test DeviceInfoReadSingle"""

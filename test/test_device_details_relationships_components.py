...
from layer8_auvik_api_client.models.device_details_relationships_components import DeviceDetailsRelationshipsComponents  # noqa: E501

class TestDeviceDetailsRelationshipsComponents(unittest.TestCase):
    """DeviceDetailsRelationshipsComponents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceDetailsRelationshipsComponents:
        """Test DeviceDetailsRelationshipsComponents
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceDetailsRelationshipsComponents`
        """
        model = DeviceDetailsRelationshipsComponents()  # noqa: E501
        if include_optional:
            return DeviceDetailsRelationshipsComponents(
                data = [
    ...
    def testDeviceDetailsRelationshipsComponents(self):
        """Test DeviceDetailsRelationshipsComponents"""

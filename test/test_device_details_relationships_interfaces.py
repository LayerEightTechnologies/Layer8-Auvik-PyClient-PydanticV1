...
from layer8_auvik_api_client.models.device_details_relationships_interfaces import DeviceDetailsRelationshipsInterfaces  # noqa: E501

class TestDeviceDetailsRelationshipsInterfaces(unittest.TestCase):
    """DeviceDetailsRelationshipsInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceDetailsRelationshipsInterfaces:
        """Test DeviceDetailsRelationshipsInterfaces
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceDetailsRelationshipsInterfaces`
        """
        model = DeviceDetailsRelationshipsInterfaces()  # noqa: E501
        if include_optional:
            return DeviceDetailsRelationshipsInterfaces(
                data = [
    ...
    def testDeviceDetailsRelationshipsInterfaces(self):
        """Test DeviceDetailsRelationshipsInterfaces"""

...
class SnmpPollerSettingsReadLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerSettingsReadLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerSettingsReadLinks:
        """Create an instance of SnmpPollerSettingsReadLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerSettingsReadLinks.parse_obj(obj)

        _obj = SnmpPollerSettingsReadLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

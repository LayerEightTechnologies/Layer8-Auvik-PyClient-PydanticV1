...
from layer8_auvik_api_client.models.interface_statistics_relationships import InterfaceStatisticsRelationships  # noqa: E501

class TestInterfaceStatisticsRelationships(unittest.TestCase):
    """InterfaceStatisticsRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsRelationships:
        """Test InterfaceStatisticsRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsRelationships`
        """
        model = InterfaceStatisticsRelationships()  # noqa: E501
        if include_optional:
            return InterfaceStatisticsRelationships(
    ...
    def testInterfaceStatisticsRelationships(self):
        """Test InterfaceStatisticsRelationships"""

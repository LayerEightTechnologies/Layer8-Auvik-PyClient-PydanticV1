...
from layer8_auvik_api_client.models.device_usage_relationships_client import DeviceUsageRelationshipsClient  # noqa: E501

class TestDeviceUsageRelationshipsClient(unittest.TestCase):
    """DeviceUsageRelationshipsClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceUsageRelationshipsClient:
        """Test DeviceUsageRelationshipsClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceUsageRelationshipsClient`
        """
        model = DeviceUsageRelationshipsClient()  # noqa: E501
        if include_optional:
            return DeviceUsageRelationshipsClient(
    ...
    def testDeviceUsageRelationshipsClient(self):
        """Test DeviceUsageRelationshipsClient"""

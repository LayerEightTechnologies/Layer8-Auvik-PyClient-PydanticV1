...
class DeviceInfoReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceInfoReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceInfoReadMultipleLinks:
        """Create an instance of DeviceInfoReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceInfoReadMultipleLinks.parse_obj(obj)

        _obj = DeviceInfoReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

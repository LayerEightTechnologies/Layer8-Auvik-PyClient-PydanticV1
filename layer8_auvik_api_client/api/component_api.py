...
class ComponentApi:
    ...
    def read_multiple_component_info(self, filter_modified_after : Annotated[Optional[StrictStr], Field(description="Filter by date and time, only returning entities modified after provided value.")] = None, filter_device_id : Annotated[Optional[StrictStr], Field(description="Filter by the component’s parent device’s ID.")] = None, filter_device_name : Annotated[Optional[StrictStr], Field(description="Filter by the component’s parent device’s name.")] = None, filter_current_status : Annotated[Optional[StrictStr], Field(description="Filter by the component’s current status.")] = None, tenants : Annotated[Optional[StrictStr], Field(description="Comma delimited list of tenant IDs to request info from.")] = None, page_first : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the first N elements will be returned. Used in combination with <code>page[after]</code>.")] = None, page_after : Annotated[Optional[StrictStr], Field(description="Cursor after which elements will be returned as a page. The page size is provided by <code>page[first]</code>.")] = None, page_last : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the last N services will be returned. Used in combination with <code>page[before]</code>.")] = None, page_before : Annotated[Optional[StrictStr], Field(description="Cursor before which elements will be returned as a page. The page size is provided by <code>page[last]</code>.")] = None, **kwargs) -> ComponentInfoReadMultiple:  # noqa: E501
        ...
        >>> thread = api.read_multiple_component_info(filter_modified_after, filter_device_id, filter_device_name, filter_current_status, tenants, page_first, page_after, page_last, page_before, async_req=True)
        >>> result = thread.get()
        ...
        :param filter_device_id: Filter by the component’s parent device’s ID.
        :type filter_device_id: str
        :param filter_device_name: Filter by the component’s parent device’s name.
        :type filter_device_name: str
        :param filter_current_status: Filter by the component’s current status.
        :type filter_current_status: str
        ...
        :rtype: ComponentInfoReadMultiple
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_multiple_component_info_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_multiple_component_info_with_http_info(filter_modified_after, filter_device_id, filter_device_name, filter_current_status, tenants, page_first, page_after, page_last, page_before, **kwargs)  # noqa: E501

    @validate_arguments
    def read_multiple_component_info_with_http_info(self, filter_modified_after : Annotated[Optional[StrictStr], Field(description="Filter by date and time, only returning entities modified after provided value.")] = None, filter_device_id : Annotated[Optional[StrictStr], Field(description="Filter by the component’s parent device’s ID.")] = None, filter_device_name : Annotated[Optional[StrictStr], Field(description="Filter by the component’s parent device’s name.")] = None, filter_current_status : Annotated[Optional[StrictStr], Field(description="Filter by the component’s current status.")] = None, tenants : Annotated[Optional[StrictStr], Field(description="Comma delimited list of tenant IDs to request info from.")] = None, page_first : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the first N elements will be returned. Used in combination with <code>page[after]</code>.")] = None, page_after : Annotated[Optional[StrictStr], Field(description="Cursor after which elements will be returned as a page. The page size is provided by <code>page[first]</code>.")] = None, page_last : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="For paginated responses, the last N services will be returned. Used in combination with <code>page[before]</code>.")] = None, page_before : Annotated[Optional[StrictStr], Field(description="Cursor before which elements will be returned as a page. The page size is provided by <code>page[last]</code>.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Read Multiple Components’ Info  # noqa: E501
        ...
        >>> thread = api.read_multiple_component_info_with_http_info(filter_modified_after, filter_device_id, filter_device_name, filter_current_status, tenants, page_first, page_after, page_last, page_before, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ComponentInfoReadMultiple, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method read_multiple_component_info" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('filter_device_name') is not None:  # noqa: E501
            _query_params.append(('filter[deviceName]', _params['filter_device_name']))

        if _params.get('filter_current_status') is not None:  # noqa: E501
            _query_params.append(('filter[currentStatus]', _params['filter_current_status']))
    ...
    def read_single_component_info(self, id : Annotated[StrictStr, Field(..., description="ID of component")], **kwargs) -> ComponentInfoReadSingle:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ComponentInfoReadSingle
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_single_component_info_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_single_component_info_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def read_single_component_info_with_http_info(self, id : Annotated[StrictStr, Field(..., description="ID of component")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Single Component’s Info  # noqa: E501
        ...
        >>> thread = api.read_single_component_info_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ComponentInfoReadSingle, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_single_component_info" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/inventory/component/info/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,

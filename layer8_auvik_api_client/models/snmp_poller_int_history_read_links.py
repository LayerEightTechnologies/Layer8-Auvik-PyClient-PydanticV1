...
class SnmpPollerIntHistoryReadLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnmpPollerIntHistoryReadLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnmpPollerIntHistoryReadLinks:
        """Create an instance of SnmpPollerIntHistoryReadLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnmpPollerIntHistoryReadLinks.parse_obj(obj)

        _obj = SnmpPollerIntHistoryReadLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

...
from layer8_auvik_api_client.models.misc_device import MiscDevice  # noqa: E501

class TestMiscDevice(unittest.TestCase):
    """MiscDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MiscDevice:
        """Test MiscDevice
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MiscDevice`
        """
        model = MiscDevice()  # noqa: E501
        if include_optional:
            return MiscDevice(

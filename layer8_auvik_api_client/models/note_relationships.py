...
class NoteRelationships(BaseModel):
    """
    This entity note's relationships to other resources  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteRelationships:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteRelationships:
        """Create an instance of NoteRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteRelationships.parse_obj(obj)

        _obj = NoteRelationships.parse_obj({

...
class DeviceWarrantyReadMultipleLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceWarrantyReadMultipleLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceWarrantyReadMultipleLinks:
        """Create an instance of DeviceWarrantyReadMultipleLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceWarrantyReadMultipleLinks.parse_obj(obj)

        _obj = DeviceWarrantyReadMultipleLinks.parse_obj({
            "next": obj.get("next"),
            "prev": obj.get("prev"),
            "first": obj.get("first"),
            "last": obj.get("last")

...
from layer8_auvik_api_client.models.interface_relationships_networks import InterfaceRelationshipsNetworks  # noqa: E501

class TestInterfaceRelationshipsNetworks(unittest.TestCase):
    """InterfaceRelationshipsNetworks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRelationshipsNetworks:
        """Test InterfaceRelationshipsNetworks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRelationshipsNetworks`
        """
        model = InterfaceRelationshipsNetworks()  # noqa: E501
        if include_optional:
            return InterfaceRelationshipsNetworks(
                data = [
    ...
    def testInterfaceRelationshipsNetworks(self):
        """Test InterfaceRelationshipsNetworks"""
